class Admin::StocksController < AdminController
  ...
  def create
    ...
    @admin_stock.product_id = params[:product_id]
    respond_to do |format|
      if @admin_stock.save
        format.html { redirect_to admin_product_stock_url(params[:product_id], @admin_stock), notice: "Stock was successfully created." }
  ...
  def update
    respond_to do |format|
      if @admin_stock.update(admin_stock_params)
        format.html { redirect_to admin_product_stock_url(params[:product_id], @admin_stock), notice: "Stock was successfully updated." }
